...
@section('title', 'Archived Donation Page')
                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        @can('donations-archive.index')
                            <div class="col-md-6">
                                <form action="{{route('donations-archive.index')}}" method="GET">
                                    <div class="d-flex">
                        ...
                        <table class="table table-hover table-vcenter text-nowrap mb-0">
                            ...
                            @forelse($donationLists as $key => $donationList)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            @can('donations-archive.unarchive')
                                                <a href="{{route('donations-archive.unarchive', $donationList->id)}}" class="btn btn-sm btn-warning" >Unarchive</a>
                                            @endcan

                                            @can('donations.destroy')
                                                <form action="{{ route('donations.destroy', $donationList->id)}}" method="POST" style="margin-left:5px;">
                                                    @csrf
                                                    @method('DELETE')
